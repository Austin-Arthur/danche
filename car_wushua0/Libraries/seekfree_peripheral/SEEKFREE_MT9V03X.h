...
//配置摄像头参数
#define MT9V03X_W               94             	//图像宽度 	范围1-188
#define MT9V03X_H               64             	//图像高度	范围1-120
#define NNN  MT9V03X_W*MT9V03X_H

extern uint8 image[64][94];
extern uint8 Show_Data[64][94]; //用来显示的数组
...
extern uint8    mt9v03x_image[MT9V03X_H][MT9V03X_W];//原始灰度图像存储
